...
class PersonalActivities extends StatefulWidget {
  final String userid;
  const PersonalActivities({super.key, required this.userid});

  @override
  State<PersonalActivities> createState() => _PersonalActivitiesState();
}

class _PersonalActivitiesState extends State<PersonalActivities> {
  ...
  Future<void> addActivity(String userid, String notes, DateTime date) async {
    try {
      ...
      await personalService.addPersonal(date, userid, notes);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Plan your personal activities",
