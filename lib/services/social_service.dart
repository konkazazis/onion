...
class SocialService {
  ...
  Future<List<Map<String, dynamic>>> fetchSocialByMonth(String month, String userid) async{
    try {
  ...
  Future<void> addSocial(DateTime date, String userid, String notes) async {
    try {
